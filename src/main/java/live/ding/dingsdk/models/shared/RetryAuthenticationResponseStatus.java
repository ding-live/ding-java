 ...
 * 
 * <p>The status of the retry. Possible values are:
...
public enum RetryAuthenticationResponseStatus {
    ...
    public static Optional<RetryAuthenticationResponseStatus> fromValue(String value) {
        for (RetryAuthenticationResponseStatus o: RetryAuthenticationResponseStatus.values()) {
